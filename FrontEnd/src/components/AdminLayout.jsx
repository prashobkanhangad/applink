...
export const AdminLayout = ({ children, title = 'Admin', subtitle = 'Overview' }) => {
  ...
  const navItems = [
    ...
    { id: 'traffic', label: 'Traffic', icon: TrafficIcon, path: '/admin/traffic' },
    { id: 'blog', label: 'Blog', icon: BlogIcon, path: '/admin/blog' },
    { id: 'auto-blog', label: 'Auto Blog', icon: AutoBlogIcon, path: '/admin/auto-blog' },
