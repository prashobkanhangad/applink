    ...
    <DashboardLayout title="API Keys" subtitle="Manage your API keys">
              ...
              <div className="space-y-4">
                {apiKeys.map((item) => (
                  <div
                    ...
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-gray-200 hover:border-primary/30 transition-colors"
                  >
                    <div className="min-w-0 flex-1">
                      <h3 className="text-sm font-medium text-gray-900 truncate">{item.name}</h3>
                      <p className="text-xs text-gray-500 mt-0.5 font-mono">{item.maskedKey}</p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 shadow-xl w-full max-w-md p-6" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <code className="flex-1 px-3 py-2 text-sm bg-gray-100 rounded-xl font-mono break-all text-gray-900">
                      {createdKey.key}
                    </code>
                    <Button
                      variant="default"
              ...
              <form onSubmit={handleCreateKey} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-200 rounded-xl bg-white text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    autoFocus
                  />
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={handleRevokeCancel}>
          <div className="bg-white rounded-2xl border border-gray-200 shadow-xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Are you sure you want to revoke <span className="font-medium text-gray-900">"{keyToRevoke.name}"</span>? It will stop working immediately.
            </p>
