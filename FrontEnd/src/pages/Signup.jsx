          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="bg-background-surface rounded-lg border border-border-default shadow-md p-8 md:p-10">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-border-default rounded-md hover:border-border-strong hover:bg-background-muted transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 mb-6"
              >
